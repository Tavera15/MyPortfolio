	      ...
	      <div className="project">
	      	...
	      	<div className="projects-section">
				  ...
				  <div className="card col-lg-4 col-md-6">
					<img src={require('../contents/CSharp/boggle.png')} className="card-img-top" alt="Boggle"/>				    
				  ...
				  <div className="card col-lg-4 col-md-6">
					<img src={require('../contents/CSharp/Invoice Gen.png')} className="card-img-top" alt="InvoiceGen"/>				    
					  <div className="card-body">
